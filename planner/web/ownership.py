...
def owned_scene(scene_id: object) -> dict | None:
...
def owned_act(act_id: object) -> dict | None:
...
def owned_link(link_id: object) -> dict | None:
...
def owned_snapshot(scene_id: object, snap_id: object) -> dict | None:
